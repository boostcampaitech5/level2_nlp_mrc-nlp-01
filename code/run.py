...
if __name__ == "__main__":
    ...
    reader = FARMReader(
        ...
        batch_size=config.batch_size,      #> 모델이 추론을 위해 한 배치에서 받는 샘플 수입니다.
        use_gpu=True,
        ...
        duplicate_filtering=0,      #> 0은 정확한 중복에 해당합니다. -1은 중복 제거를 끕니다. 답변의 시작 위치와 끝 위치가 모두 고려되며 위치에 따라 필터링됩니다. 값이 높을수록 더 많이 떨어져 있는 답변이 필터링됨
